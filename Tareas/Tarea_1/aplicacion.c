...
int main(){
	...
	fdOpcion = abrirParametro("/sys/module/Tarea_KThread_1/parameters/Opcion");
	...
	while(op != 5){
		...
		if ( op == 1){
			fdPromedio = abrirParametro("/sys/module/Tarea_KThread_1/parameters/Promedio");
			...
			fdNumElem = abrirParametro("/sys/module/Tarea_KThread_1/parameters/Numeros");
			...
			fdNumElemPares = abrirParametro("/sys/module/Tarea_KThread_1/parameters/NumerosPares");
